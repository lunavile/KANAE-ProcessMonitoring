...
for (model_a, model_b), probs in results_by_pair.items():
    ...
    line1, = ax.plot(sample_sizes, probs["Pleft"], marker='o',
                     label=r"$P(A \gg B)$", linestyle=(0, (3, 3)))
    line2, = ax.plot(sample_sizes, probs["Prope"], marker='o',
                     label=r"$P(A \approx B)$", linestyle=(0, (4, 2, 1, 2)))
    line3, = ax.plot(sample_sizes, probs["Pright"], marker='o',
                     label=r"$P(A \ll B)$", linestyle=(0, (6, 2)))
