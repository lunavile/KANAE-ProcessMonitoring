...
def get_efficientkan_model(input_size, **kwargs):
    # All expected keys must be provided in kwargs
    return KAN(
        layers_hidden=kwargs["layers_hidden"],
        ...
        base_activation=ACTIVATION_MAP[kwargs["base_activation"]],
        grid_eps=kwargs["grid_eps"],
        grid_range=kwargs["grid_range"],
        regularize_activation=kwargs["regularize_activation"],
        regularize_entropy=kwargs["regularize_entropy"]
    )
