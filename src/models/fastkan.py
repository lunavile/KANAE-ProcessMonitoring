...
def get_fastkan_model(input_size: int, **kwargs):
    
    return FastKAN(
        layers_hidden=kwargs["layers_hidden"],
        grid_min=kwargs["grid_min"],
        grid_max=kwargs["grid_max"],
        num_grids=kwargs["num_grids"],
        use_base_update=kwargs["use_base_update"],
        base_activation=ACTIVATION_MAP[kwargs["base_activation"]],
        spline_weight_init_scale=kwargs["spline_weight_init_scale"]
    )    